...
Текущая стабильная версия: **1.1.0**. Основные функции готовы к повседневному
использованию. Дальнейшие выпуски 1.x посвящены исправлениям и развитию приложения.

## Скачать

- [YMPlayer 1.1.0 в GitHub Releases](https://github.com/reziarlleh/YMPlayer/releases/tag/v1.1.0)
- [Скачать APK](https://github.com/reziarlleh/YMPlayer/releases/download/v1.1.0/YMPlayer-v1.1.0-release-b114.apk)
- [Резервная загрузка через jsDelivr](https://cdn.jsdelivr.net/gh/reziarlleh/YMPlayer@v1.1.0/releases/1.1.0/YMPlayer-v1.1.0-release-b114.apk)
- [APK в архиве репозитория](releases/1.1.0/YMPlayer-v1.1.0-release-b114.apk)
...
- Адаптивный интерфейс для вертикальных и горизонтальных экранов.
- Двухстрочная панель сообщений снизу с раскрываемым журналом, отдельно от
  системных панелей. В полноэкранных клипах постоянной панели нет.
- Крупные круглые кнопки воспроизведения с сохранением привычного порядка.

### Музыка

- Динамическое воспроизведение "Моей волны" с подготовкой следующего трека.
- Воспроизведение понравившихся треков без интернета.
- Одна кнопка синхронизации избранного: музыка и обложки скачиваются вместе,
  недостающие и повреждённые файлы восстанавливаются без перезагрузки исправных.
- Обложки избранного сохраняются для показа без интернета.
...
- Полноэкранная динамическая очередь музыкальных клипов без статус-бара приложения.
...
- Автоматический выбор управления: D-pad на Android TV и одно касание на
  обычном Android, с ручным переопределением в настройках.
...
Нажатие на нижнюю строку состояния раскрывает полный статус и журнал с переносами
строк. Панель занимает до 45% доступной высоты и прокручивается; повторное
нажатие сворачивает её. С пульта: OK для раскрытия, вверх/вниз для прокрутки,
OK или «Назад» для сворачивания.
