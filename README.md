...
Текущая версия: **1.0.0-beta.13**. Основные функции завершены; статус beta оставлен
для длительного тестирования на разных устройствах и версиях сервисов Яндекса.

## Скачать

- [YMPlayer 1.0.0-beta.13 в GitHub Releases](https://github.com/reziarlleh/YMPlayer/releases/tag/v1.0.0-beta.13)
- [Скачать APK](https://github.com/reziarlleh/YMPlayer/releases/download/v1.0.0-beta.13/YMPlayer-v1.0.0-beta.13-release-b113.apk)
- [Резервная загрузка через jsDelivr](https://cdn.jsdelivr.net/gh/reziarlleh/YMPlayer@v1.0.0-beta.13/releases/1.0.0-beta.13/YMPlayer-v1.0.0-beta.13-release-b113.apk)
- [APK в архиве репозитория](releases/1.0.0-beta.13/YMPlayer-v1.0.0-beta.13-release-b113.apk)
...
- Постоянная двухстрочная панель сообщений снизу, отдельно от системных панелей.
