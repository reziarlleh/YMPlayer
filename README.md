...
Текущая версия: **1.0.0-beta.5**. Основные функции завершены; статус beta оставлен
для длительного тестирования на разных устройствах и версиях сервисов Яндекса.

## Скачать

- [YMPlayer 1.0.0-beta.5 в GitHub Releases](https://github.com/reziarlleh/YMPlayer/releases/tag/v1.0.0-beta.5)
- [Скачать APK](https://github.com/reziarlleh/YMPlayer/releases/download/v1.0.0-beta.5/YMPlayer-v1.0.0-beta.5-release-b105.apk)
- [APK в архиве репозитория](releases/1.0.0-beta.5/YMPlayer-v1.0.0-beta.5-release-b105.apk)
