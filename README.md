...
Android 10 и новее. Приложение рассчитано на смартфоны и автомобильные
...
Текущая версия: **1.0.0-beta**. Основные функции завершены; статус beta оставлен
для длительного тестирования на разных устройствах и версиях сервисов Яндекса.

## Скачать

- [YMPlayer 1.0.0-beta в GitHub Releases](https://github.com/reziarlleh/YMPlayer/releases/tag/v1.0.0-beta)
- [Скачать APK](https://github.com/reziarlleh/YMPlayer/releases/download/v1.0.0-beta/YMPlayer-v1.0.0-beta-release-b100.apk)
- [APK в архиве репозитория](releases/1.0.0-beta/YMPlayer-v1.0.0-beta-release-b100.apk)
...
2. Откройте настройки YMPlayer и войдите в аккаунт Яндекса.
